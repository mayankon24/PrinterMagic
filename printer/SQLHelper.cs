...
namespace printer
{
    public class SQLHelper
    {
        ...
        {
           sqlConnStr = System.Configuration.ConfigurationManager.ConnectionStrings["printer.Properties.Settings.DataConnectionString1"].ToString();
        ...
        /// </param>
        /// <returns>Datable with the select query result </returns>
        public decimal ExecuteScalarProcedure(String procedureName, SqlTransaction transaction, params SqlParameter[] parameters)
        {
            try
            {
